...
public class TestScroll {
	...
	static Mario m = new Mario("Mario", 50, 50, 100, 100, "rock1.png");
	static Texto t = new Texto("texto", 50, 50, 100, 100, "ESTO NO SE MUEVE POR MAS QUE SCROLLEES");
	static Suelo suelo = new Suelo("Suelo", -500, 300, 800, 320, "b84.png");
	static String[] musicas = {"mario.wav","otra.wav"};
